...
(def v17_l117 (def eig-reals (la/re (:eigenvalues eig-result))))


(def v18_l119 (< (abs (- (la/trace A-eig) (la/sum eig-reals))) 1.0E-10))
...
(def v23_l154 (def A-diag (t/matrix [[2 1] [0 3]])))
...
(def
 ...
 (def
  ...
  (let
   ...
   (t/hstack
    (mapv (fn* [p1__84644#] (nth evecs p1__84644#)) sorted-idx)))))
...
(def v48_l251 (la/norm (la/sub QtQ (t/eye 3))))
...
(def
 v69_l394
 (every?
  (fn* [p1__84645#] (>= p1__84645# -1.0E-10))
...
(def v103_l507 (long (la/sum (elem/gt (:S final-svd) 1.0E-10))))
