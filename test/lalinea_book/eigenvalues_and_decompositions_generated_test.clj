...
(def v7_l63 (def A-eig (t/matrix [[4 1 2] [0 3 1] [0 0 2]])))


(def v9_l71 (def eig-result (la/eigen A-eig)))
...
(def
 ...
 (def
  ...
  (let
   ...
   (t/hstack
    (mapv (fn* [p1__85977#] (nth evecs p1__85977#)) sorted-idx)))))
...
(def
 v69_l395
 (every?
  (fn* [p1__85978#] (>= p1__85978# -1.0E-10))
