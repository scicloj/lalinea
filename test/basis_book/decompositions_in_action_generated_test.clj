...
(def v34_l194 cov-matrix)


(deftest
 t35_l196
 (is ((fn [m] (= [2 2] (vec (dtype/shape m)))) v34_l194)))


(def v36_l199 (def pca-eigen (la/eigen cov-matrix)))
...
(deftest
 t39_l206
 (is ((fn [evs] (> (ffirst evs) (first (second evs)))) v38_l203)))
...
(deftest t42_l239 (is ((fn [_] true) v41_l213)))
